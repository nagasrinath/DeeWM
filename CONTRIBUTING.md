...
Dwmac project doesn't accept Issues directly - we ask you to create a [Discussion](https://github.com/hillyu/Dwmac/discussions) first.
...
As an alternative, you can start a Discussion on [GitHub discussions](https://github.com/hillyu/Dwmac/discussions) forum.
...
Submit bugs to https://github.com/hillyu/Dwmac/discussions/categories/potential-bugs
Submit feature ideas to https://github.com/hillyu/Dwmac/discussions/categories/feature-ideas
...
* `dwmac debug-windows` output, if the problem is about handling some windows
...
* Most voted issues: https://github.com/hillyu/Dwmac/issues?q=is%3Aissue+is%3Aopen+sort%3Areactions-%2B1-desc
* Sometimes conversations happen on old issues that aren’t yet closed. See https://github.com/hillyu/Dwmac/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc
* Issues that are unclear on how to fix, or issues that require design of the interface (CLI or config interface) are tagged with `design-needed` tag https://github.com/hillyu/Dwmac/issues?q=is%3Aissue+is%3Aopen+label%3Adesign-needed
...
Do you like the project? Does Dwmac finally fix your problems with windows management on macOS? Good to hear it!

* Spread the word in social networks! (Don't forget to share the link :) )
* Talk about Dwmac to your colleagues and friends
* Write a blogpost about your workflows
* Record a YouTube video

## Share your workflow and tips

Submit your tips to [the Goodies page](https://hillyu.github.io/Dwmac/goodies). The source code of the page can be found in `./docs` directory

## Support the project financially

Supporting the project financially counts as a contribution (even if it's just a $1/month). https://github.com/sponsors/hillyu
