...
private let serverHelp = """
    USAGE: \(CommandLine.arguments.first ?? "DeeWM.app/Contents/MacOS/DeeWM") [<options>]

    OPTIONS:
      -h, --help              Print help
      -v, --version           Print DeeWM.app version
      --config-path <path>    Config path. It will take priority over ~/.deewm.toml
                              and ${XDG_CONFIG_HOME}/deewm/deewm.toml
