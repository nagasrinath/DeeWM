...
let subcommandDescriptions = [
    ...
    ["  config", "Query DeeWM config options"],
    ...
    ["  eval", "Send multiple commands to DeeWM at once"],
    ...
    ["  run-callback", "Run DeeWM config callbacks on demand"],
    ["  split", "Split focused window"],
    ["  subscribe", "Subscribe to DeeWM events and receive notifications via socket"],
    ...
    ["  trigger-binding", "Trigger DeeWM binding as if it was pressed by user"],
