...
:manname: dwmac-config
// tag::purpose[]
:manpurpose: Query Dwmac config options
// end::purpose[]
...
[verse]
// tag::synopsis[]
dwmac config [-h|--help] --get <name> [--json] [--keys]
dwmac config [-h|--help] --major-keys
dwmac config [-h|--help] --all-keys
dwmac config [-h|--help] --config-path
...
+
----
$ dwmac config --get mode.main.binding --json
{
  "alt-w" : "workspace W",
  "alt-y" : "workspace Y",
  "alt-n" : "workspace N",
