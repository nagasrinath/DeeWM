= dwmac-focus-back-and-forth(1)
include::util/man-attributes.adoc[]
// tag::purpose[]
:manpurpose: Switch between the current and previously focused elements back and forth
// end::purpose[]
:manname: dwmac-focus-back-and-forth

// =========================================================== Synopsis
== Synopsis
[verse]
// tag::synopsis[]
dwmac focus-back-and-forth [-h|--help]
...
Dwmac stores only one previously focused window in history,
...
----
dwmac focus-back-and-forth || dwmac workspace-back-and-forth
----
