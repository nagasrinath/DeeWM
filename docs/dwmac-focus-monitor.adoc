= dwmac-focus-monitor(1)
include::util/man-attributes.adoc[]
:manname: dwmac-focus-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
dwmac focus-monitor [-h|--help] [--wrap-around] (left|down|up|right)
dwmac focus-monitor [-h|--help] [--wrap-around] (next|prev)
dwmac focus-monitor [-h|--help] <monitor-pattern>...
