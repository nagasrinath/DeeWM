= dwmac-list-windows(1)
include::util/man-attributes.adoc[]
:manname: dwmac-list-windows
// tag::purpose[]
...
[verse]
// tag::synopsis[]
dwmac list-windows [-h|--help] (--workspace <workspace>...|--monitor <monitor>...)
                       [--monitor <monitor>...] [--workspace <workspace>...]
                       [--pid <pid>] [--app-bundle-id <app-bundle-id>] [--format <output-format>]
                       [--count] [--json]
dwmac list-windows [-h|--help] --all [--format <output-format>] [--count] [--json]
dwmac list-windows [-h|--help] --focused [--format <output-format>] [--count] [--json]
...
%{window-is-fullscreen}:: Boolean. Is window in fullscreen by `dwmac fullscreen` command
%{window-layout}:: String. Alias for `%{window-parent-container-layout}`
%{window-parent-container-layout}:: String. The layout (`v_master-stack`, `h_master-stack`, `floating`) of the window's parent container.
...
%{workspace-root-container-layout}:: String. The layout (`v_master-stack`, `h_master-stack`) of the workspace the window belongs to.
