= dwmac-list-workspaces(1)
include::util/man-attributes.adoc[]
:manname: dwmac-list-workspaces
// tag::purpose[]
...
[verse]
// tag::synopsis[]
dwmac list-workspaces [-h|--help] --monitor <monitor>... [--visible [no]] [--empty [no]] [--format <output-format>] [--count] [--json]
dwmac list-workspaces [-h|--help] --all [--format <output-format>] [--count] [--json]
dwmac list-workspaces [-h|--help] --focused [--format <output-format>] [--count] [--json]
...
%{workspace-root-container-layout}:: String. The layout (`v_master-stack`, `h_master-stack`) of the workspace's root container
