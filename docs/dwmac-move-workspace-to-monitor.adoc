= dwmac-move-workspace-to-monitor(1)
include::util/man-attributes.adoc[]
:manname: dwmac-move-workspace-to-monitor
// tag::purpose[]
...
[verse]
// tag::synopsis[]
dwmac move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (left|down|up|right)
dwmac move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--wrap-around] (next|prev)
dwmac move-workspace-to-monitor [-h|--help] [--workspace <workspace>] <monitor-pattern>...
