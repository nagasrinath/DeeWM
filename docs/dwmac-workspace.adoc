...
[verse]
// tag::synopsis[]
dwmac workspace [-h|--help] [--auto-back-and-forth] [--fail-if-noop] <workspace-name>
dwmac workspace [-h|--help] [--wrap-around] [--stdin|--no-stdin] (next|prev)
...
`dwmac list-workspaces --monitor focused --empty no | dwmac workspace next`
