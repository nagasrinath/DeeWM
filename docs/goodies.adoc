...
Do you have a cool automatization, Dwmac integration, or workflow?
...
[#raycast-extension]
== Dwmac Raycast extension

There is a third party Raycast extension for Dwmac. https://www.raycast.com/limonkufu/dwmac
...
[source,bash]
----
dwmac workspace "$(dwmac list-workspaces --monitor mouse --visible)" && dwmac workspace next

dwmac workspace "$(dwmac list-workspaces --monitor mouse --visible)" && dwmac workspace prev
----
...
* https://github.com/acsandmann/dwmac-swipe
* link:https://folivora.ai/[BetterTouchTool] can assign arbitrary commands to trackpad gestures.
Beware that you might need to specify full path to dwmac executable https://community.folivora.ai/t/how-to-execute-terminal-command-to-switch-workspaces-with-dwmac/35914
* https://github.com/MediosZ/SwipeDwmac
...
[#show-dwmac-workspaces-in-sketchybar]
== Show Dwmac workspaces in Sketchybar

You can integrate Dwmac workspace indicators with link:https://github.com/FelixKratz/SketchyBar[Sketchybar].
...
[#show-dwmac-workspaces-in-simple-bar]
== Show Dwmac workspaces in simple-bar

link:https://github.com/Jean-Tinland/simple-bar[simple-bar] can be used to display Dwmac workspaces.
